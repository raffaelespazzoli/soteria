...
KIND_CLUSTER ?= dr-orchestrator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name dr-orchestrator-builder
	$(CONTAINER_TOOL) buildx use dr-orchestrator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm dr-orchestrator-builder
	rm Dockerfile.cross
