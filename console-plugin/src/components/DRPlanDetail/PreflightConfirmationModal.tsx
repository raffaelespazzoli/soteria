  ...
  return (
    ...
    >
      ...
      <ModalBody>
        ...
        <div
          style={{
            marginBottom: 'var(--pf-t--global--spacer--lg, var(--pf-v5-global--spacer--lg))',
          }}
        >
          DR site capacity:{' '}
        ...
        <hr
          style={{
            border: 'none',
            borderTop:
              '1px solid var(--pf-t--global--border--color--default, var(--pf-v5-global--BorderColor--100))',
        ...
        {error && (
          <Alert
            ...
            style={{
              marginTop: 'var(--pf-t--global--spacer--md, var(--pf-v5-global--spacer--md))',
            }}
          >
            {error}
          </Alert>
