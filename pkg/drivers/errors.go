...
var (
	...
	ErrPromotionFailed     = errors.New("volume promotion failed")
	ErrDemotionFailed      = errors.New("volume demotion failed")
	ErrResyncFailed        = errors.New("volume resync failed")
